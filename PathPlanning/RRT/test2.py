...
def main():
    ...
    destinations = [
        ...
        {'name': 'Destination 2', 'location': LocationGlobalRelative(51.71506, 0.461, 56)},
        {'name': 'Destination 3', 'location': LocationGlobalRelative(51.731, 0.462, 33)}
    ]

    fences = [
        {'name': 'Fence 1', 'lat': 51.71106, 'lon': 0.47100, 'radius': 0.0031477},
        {'name': 'Fence 2', 'lat': 51.719071, 'lon': 0.4772688, 'radius': 0.0041471},
        {'name': 'Fence 2', 'lat': 51.715071, 'lon': 0.4858, 'radius': 0.0041471},
        {'name': 'Fence 3', 'lat': 51.725, 'lon': 0.465, 'radius': 0.00448}
    ]
    ...
    fig2, ax1 = plt.subplots(figsize=(12, 12))
