...
def gcost(fixed_node, update_node_coordinate):
    ...
    gc = math.hypot(dx, dy)  # g for move from fixed_node to update_node
    gcost = fixed_node.G + gc  # g for move from start point to update_node
    return gcost
