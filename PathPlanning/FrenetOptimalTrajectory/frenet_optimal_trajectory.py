...
def calc_frenet_paths(c_speed, c_d, c_d_d, c_d_dd, s0, s0_target, c_speed_target):
    ...
    if follow_mode:
        ...
        for di in np.arange(-MAX_ROAD_WIDTH, MAX_ROAD_WIDTH, D_ROAD_W):
            ...
            for Ti in np.arange(MINT, MAXT, DT):
                ...
                s_targetddot = 0.0
                lon_qp = quintic_polynomial(s0, c_speed, s_lv1ddot, s_target, s_targetdot, s_targetddot, Ti)
...
def frenet_optimal_planning(csp, s0, c_speed, c_d, c_d_d, c_d_dd, ob, s0_target, c_speed_target):
    ...
    global low_velocity, velocity_keeping, follow_mode
    ...
    if(c_speed == 0.0):
        ...
        fplist = calc_frenet_paths(c_speed, c_d, c_d_d, c_d_dd, s0, 0.0, 0.0)
        fplist = calc_global_paths(fplist, csp)
        fplist = check_paths(fplist, ob)
    else:
        low_velocity = False
        velocity_keeping = True
        follow_mode = False
        print("###############")
        ...
        if not fplist:
            ...
            fplist = calc_frenet_paths(c_speed, c_d, c_d_d, c_d_dd, s0, s0_target, c_speed_target)
            fplist = calc_global_paths(fplist, csp)
            fplist = check_paths(fplist, ob)
