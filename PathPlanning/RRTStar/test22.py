...
from rrt_star import RRTStar  # Import RRTStar from the module
...
def main():
    ...
    fences = [
        ...
        {'name': 'Fence 2', 'lat': 51.719071, 'lon': 0.4772688, 'radius': 0.001471},
        {'name': 'Fence 3', 'lat': 51.725, 'lon': 0.485, 'radius': 0.00448}
    ]

    fig, ax = plt.subplots(figsize=(14, 14))  # Increase the figure size
    ...
    for i in range(len(waypoints) - 1):
        ...
        rrt_star = RRTStar(start=start, goal=goal, rand_area=[-2, 15], obstacle_list=obstacleList)
